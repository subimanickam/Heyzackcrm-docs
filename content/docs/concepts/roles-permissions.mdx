---
title: "Roles and permissions in the Partner Portal"
description: "Learn how Admin, Manager, and Support roles work in the Heyzack Partner Portal, and how to control which menu sections each user can access."
---

The Partner Portal uses a role-based access system to control what each user can see and do. There are three roles — Admin, Manager, and Support — and for Manager and Support users you can fine-tune access by enabling or disabling individual menu items. This lets you give team members exactly the access they need without exposing unrelated parts of the portal.
...
Each Manager and Support user has a set of menu permissions that controls which sections of the portal appear in their sidebar. You can enable or disable any of the following menu items per user:
...
| Chat | Messaging between portal users and field contacts |
| Payments | Payment records and transaction history |
| Activity Logs | Audit trail of portal activity |
| Settings | User management and account settings |

If a user has no permissions assigned (empty permissions list), the portal treats them as having full access and shows all menu items.
...
To add a new user to the portal:
