...
description: "View, create, and update customer orders and analyse revenue trends with date-range filters, partner breakdowns, and CSV export in the CRM."
---
...
![Create order button on dashboard](/orders-creating-order-button.png)

- **Orders page** — click the **Create Order** button in the top-right of the page header.

![Create order button on orders page](/orders-creating-order-button-orders-page.png)
