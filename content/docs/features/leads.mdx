...
description: "Capture and manage potential customers in the Heyzack Partner Portal — qualify leads, generate partner referral tokens, and convert them to orders."
---
