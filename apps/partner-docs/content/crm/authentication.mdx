---
title: "Authenticate with the Heyzack CRM"
description: "Learn how to sign in to the CRM, obtain a bearer token for API access, and handle token expiry and common authentication errors."
---
