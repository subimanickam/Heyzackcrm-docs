...
<figure className="my-8 mx-auto w-full max-w-5xl rounded-lg border border-border bg-muted/15 p-2 shadow-sm">
  <img
    ...
    alt="HeyZack Admin Portal — Settings, Create User tab: Create New User form with Full Name, Email, Password, Role dropdown, Menu Permissions checkboxes (Dashboard, Orders, Sales Report, and more), Select All, Cancel and Create User buttons"
    width={1440}
    height={900}
