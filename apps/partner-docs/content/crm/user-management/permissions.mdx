...
<figure className="my-8 mx-auto w-full max-w-5xl rounded-lg border border-border bg-muted/15 p-2 shadow-sm">
  <img
    ...
    alt="HeyZack Admin Portal — Settings, Create User tab showing Create New User form and Menu Permissions checkboxes including Dashboard, Orders, Sales Report, and more"
    width={1440}
    height={900}
